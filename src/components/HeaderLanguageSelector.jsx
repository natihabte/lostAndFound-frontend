...
const HeaderLanguageSelector = ({ className = '' }) => {
  ...
  const handleLanguageChange = (languageCode) => {
    ...
    i18n.changeLanguage(languageCode).then(() => {
      ...
      // Save to localStorage (handled automatically by i18next)
  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      ...
      <button
        ...
        className="flex items-center space-x-2 px-3 py-2 text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-md transition-colors border border-gray-200 hover:border-gray-300 bg-white shadow-sm"
